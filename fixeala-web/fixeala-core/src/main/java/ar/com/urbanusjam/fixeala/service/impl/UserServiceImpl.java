...
import ar.com.urbanusjam.fixeala.dao.ActivationDAO;
import ar.com.urbanusjam.fixeala.dao.AuthorityDAO;
import ar.com.urbanusjam.fixeala.dao.PasswordResetDAO;
		...
		if(operation.equals(PASSWORD_FORGOT)){		
			...
			if(userDAO.findPassword(username, passwordChange.getCurrentPassword())){
				...
				try{
					...
					logger.debug("Error en el envio del email por cambio de clave.");			
				}
